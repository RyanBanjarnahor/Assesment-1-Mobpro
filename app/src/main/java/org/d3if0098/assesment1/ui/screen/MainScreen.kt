package org.d3if0098.assesment1.ui.screen
...
import org.d3if0098.assesment1.R
import org.d3if0098.assesment1.navigation.Screen
import org.d3if0098.assesment1.ui.theme.Assesment1Theme
...
fun ScreenContent(modifier: Modifier) {
    ...
    val radioOptions1 = listOf(
        stringResource(id = R.string.es_teh)
    )
    val radioOptions2 = listOf(
        stringResource(id = R.string.nutrisari)
    )
    val radioOptions3 = listOf(
        stringResource(id = R.string.kopi)
    )
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.drinking_intro),
        ...
        Column (
            ...
            Row {
                Image(
                    painter = painterResource(id = R.drawable.es_teh),
            ...
            Row {
                Image(
                    painter = painterResource(id = R.drawable.nutrisari),
                    contentDescription = null,
                    contentScale = ContentScale.Crop,
                    modifier = Modifier
                        .size(180.dp)
        ...
        OutlinedTextField(
            ...
            label = { Text(text = stringResource(R.string.jumlah_pesanan))},
            isError = jumlahError,
        ...
        if (totalHarga != 0f) {
            ...
            Button(
                onClick = {
                    shareData(
                        context = context,
                        message = context.getString(R.string.bagikan_text,
